...
from data_processing.optimized_dataframes_processing import *
...
def process_data(rule_names, start_age, end_age, start_date, end_date, BMI_lower_limit, BMI_upper_limit, data_select):
    ...
    df_patient = get_demographic_data(user_data_file, df_weight, df_height, data_select, start_age, end_age,
                                      BMI_lower_limit, BMI_upper_limit)

    processed_dataframes, min_date, max_date = process_common_df(rule_names, df_patient, common_params, trend_window,
                                                                 data_select, start_age, end_age)
    ...
    for rule_name in rule_names:
        if rule_name == 'ruleset1_V2_1_Fitness_VO2max_Fatness_BMI_rule':
            ...
            ehi_dataframes[rule_name] = merged_df
            ...
            ehi_dataframes[rule_name] = processed_hrrra_dataframe
            ...
            ehi_dataframes[rule_name] = processed_drs_dataframe
            ...
            ehi_dataframes[rule_name] = processed_osa_dataframe
            ...
            ehi_dataframes[rule_name] = processed_cad_dataframe
            ...
            processed_hr_dataframe['assessment'] = processed_hr_dataframe.apply(ruleset4_V2_1_extreme_Heart_Rate_rule,
                                                                                axis=1)
            ehi_dataframes[rule_name] = processed_hr_dataframe
            ...
            ehi_dataframes[rule_name] = processed_hrv_dataframe
            ...
            processed_prq_dataframe['assessment'] = processed_prq_dataframe.apply(ruleset4_V2_1_extreme_PRQ_rule,
                                                                                  axis=1)
            ehi_dataframes[rule_name] = processed_prq_dataframe
            ...
            ehi_dataframes[rule_name] = processed_cv_dataframe
            ...
            processed_sbp_dataframe['assessment'] = processed_sbp_dataframe.apply(ruleset4_V3_1_extreme_SBP_rule,
                                                                                  axis=1)
            ehi_dataframes[rule_name] = processed_sbp_dataframe
            ...
            processed_dbp_dataframe['assessment'] = processed_dbp_dataframe.apply(ruleset4_V3_1_extreme_DBP_rule,
                                                                                  axis=1)
            ehi_dataframes[rule_name] = processed_dbp_dataframe
            ...
            ehi_dataframes[rule_name] = merged_hr_hrv
            ...
            ehi_dataframes[rule_name] = merged_sbp_dbp
            ...
            ehi_dataframes[rule_name] = merged_stress
            ...
            ehi_dataframes[rule_name] = processed_pulsepressure_dataframe
            ...
            ehi_dataframes.update({rule_name: processed_einstability_dataframe})
            ...
            ehi_dataframes.update({rule_name: processed_ei_dataframe})
            ...
            ehi_dataframes.update({rule_name: processed_ev_dataframe})
            ...
            ehi_dataframes[rule_name] = processed_target_hr_dataframe
            ...
            processed_rr_dataframe['assessment'] = processed_rr_dataframe.apply(
                ...
                axis=1)
            ehi_dataframes[rule_name] = processed_rr_dataframe
            ...
            ehi_dataframes[rule_name] = df_cardiac_index
    return ehi_dataframes, min_date, max_date, min_age, max_age, min_bmi, max_bmi
